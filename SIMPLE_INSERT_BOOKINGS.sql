-- Simple INSERT query for Booking table
-- Run this in SQL Server Management Studio or Visual Studio SQL Server Object Explorer

-- Insert 15 test bookings (BookingId will be auto-generated)
...
-- Verify the insert
SELECT COUNT(*) AS 'Total Bookings Inserted' FROM Bookings WHERE TravelerFirstName IN ('John', 'Sarah', 'Michael', 'Emily', 'David', 'Jessica', 'Robert', 'Amanda', 'James', 'Linda', 'Christopher', 'Patricia', 'Daniel', 'Nancy', 'Matthew');
